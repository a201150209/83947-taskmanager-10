...
/* harmony import */ var _components_card_edit_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/card-edit.js */ "./src/components/card-edit.js");
...
renderTemplate(menuWrapperElement, Object(_components_menu_js__WEBPACK_IMPORTED_MODULE_0__["createMenuTemplate"])());
renderTemplate(mainElement, Object(_components_filters_js__WEBPACK_IMPORTED_MODULE_1__["createFiltersTemplate"])());
renderTemplate(mainElement, Object(_components_board_js__WEBPACK_IMPORTED_MODULE_2__["createBoardTemplate"])());

const boardElement = mainElement.querySelector(SelectorElement.BOARD);
renderTemplate(boardElement, Object(_components_load_more_button_js__WEBPACK_IMPORTED_MODULE_3__["createLoadMoreButtonTemplate"])());

const cardsWrapperElement = boardElement.querySelector(SelectorElement.CARD_WRAPPER);
renderTemplate(cardsWrapperElement, Object(_components_card_edit_js__WEBPACK_IMPORTED_MODULE_5__["createCardEditTemplate"])());
for (let i = 0; i < MAX_CARDS_QUANTITY; i++) {
  renderTemplate(cardsWrapperElement, Object(_components_card_js__WEBPACK_IMPORTED_MODULE_4__["createCardTemplate"])());
}
